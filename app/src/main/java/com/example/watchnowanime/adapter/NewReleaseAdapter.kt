...
class NewReleaseAdapter(context: Context) : RecyclerView.Adapter<NewReleaseAdapter.AnimeViewHolder>() {
    ...
    private val differCallback = object : DiffUtil.ItemCallback<NewReleaseItem>(){

        override fun areItemsTheSame(oldItem: NewReleaseItem, newItem: NewReleaseItem): Boolean {
            return oldItem.animeId == newItem.animeId
        }

        override fun areContentsTheSame(oldItem: NewReleaseItem, newItem: NewReleaseItem): Boolean {
