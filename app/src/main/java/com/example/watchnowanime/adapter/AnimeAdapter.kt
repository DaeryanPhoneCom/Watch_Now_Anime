...
import com.example.watchnowanime.ui.fragments.HomeFragmentDirections

class AnimeAdapter(context: Context, val recyclerViewInterface: RecyclerViewInterface) : RecyclerView.Adapter<AnimeAdapter.AnimeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AnimeViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            //recyclerViewInterface.onItemClick(anime.animeId)
